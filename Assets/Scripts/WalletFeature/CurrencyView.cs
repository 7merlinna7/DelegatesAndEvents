...
public class CurrencyView : MonoBehaviour
{
    ...
    public void Initialize() => _currencyViewImage.rectTransform.anchoredPosition = _currencyViewOffset;

    public void UpdateText(int value) => _currencyViewText.text = value.ToString();
}
